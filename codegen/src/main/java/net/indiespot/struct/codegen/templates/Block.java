...
public class Block<T> {
    ...
    public T add(T src) {
        T dst = this.add();
        Struct.copy(Object.class, src, dst);
        return dst;
    }
    ...
    public void addRange(Block<T> src, int off, int len) {
        ...
        this.size += len;
        Struct.copy(Object.class, src.get(off), this.get(offset), len);
    }
    ...
    public void addAll(Block<T> src) {
        ...
        int offset = this.size;
        this.size += src.size;
        Struct.copy(Object.class, src.base, this.get(offset), src.size);
    }
    ...
    public void set(int index, T value) {
        Struct.copy(Object.class, value, this.get(index));
    }
