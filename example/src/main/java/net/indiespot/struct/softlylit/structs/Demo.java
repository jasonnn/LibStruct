...
import net.indiespot.struct.softlylit.structs.support.LineBlock;
import net.indiespot.struct.softlylit.structs.support.OpenGL;
import net.indiespot.struct.softlylit.structs.support.TriangleBlock;
...
public class Demo {
    ...
    private static final List<Long> JAVA_GC_DURATIONS = new ArrayList<Long>();
    private static final List<Long> STRUCT_GC_DURATIONS = new ArrayList<Long>();
