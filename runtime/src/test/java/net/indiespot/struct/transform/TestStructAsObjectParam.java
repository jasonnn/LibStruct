...
public class TestStructAsObjectParam extends AbstractRuntimeTest {

    @Test
    public void testMixedWithNulls() throws Exception {
        Vec3 vec = new Vec3();
    ...
    @Test
    public void testMixedWithString() throws Exception {
        Vec3 vec = new Vec3();
    ...
    @Test
    public void testMixedNullableStructs() throws Exception {
