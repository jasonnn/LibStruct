...
public class StructTest extends TestBase {
    ...
    public void testFromPointer() throws Exception {
        ...
        long expectedPtr_v1 = (addr + 0 * Struct.sizeof(Vec3.class));
        long expectedPtr_v2 = (addr + 1 * Struct.sizeof(Vec3.class));
        Assert.assertEquals(expectedPtr_v1, Struct.getPointer(v1));
        Assert.assertEquals(expectedPtr_v2, Struct.getPointer(v2));
    ...
    public void testDuplicateOverloadedMethod() throws Exception {
        ...
        TestDuplicateOverloadedMethod.test(new Ship());
